...
class GuruController extends Controller
{
    public function index()
    {
        ...
        return view('backend.akademik.guru.index', compact('data'));
    }

    public function create()
    {
        return view('backend.akademik.guru.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('guru.index')->with('success', 'Guru berhasil ditambahkan. Data otomatis tersinkronisasi dengan Pengguna.');
    }

    public function edit($id)
    {
        $data = Guru::findOrFail($id);
        return view('backend.akademik.guru.edit', compact('data'));
    }
