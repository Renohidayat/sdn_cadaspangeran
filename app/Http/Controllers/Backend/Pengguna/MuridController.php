...
class MuridController extends Controller
{
    public function index()
    {
        ...
        return view('backend.pengguna.murid.index', compact('data'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('backend-pengguna-murid.index')->with('success', 'Siswa berhasil ditambahkan.');
    }
    ...
    public function edit($id)
    {
        ...
        $kelas = \App\Models\Kelas::all();
        return view('backend.pengguna.murid.edit', compact('data', 'kelas'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('backend-pengguna-murid.index')->with('success', 'Siswa berhasil diupdate.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('backend-pengguna-murid.index')->with('success', 'Siswa berhasil dihapus.');
    }
}
