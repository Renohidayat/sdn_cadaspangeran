                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body mt-2">
                            ...
                            @endif
                            <form action="{{ route('backend-pengguna-pengajar.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                <a href="{{ route('backend-pengguna-pengajar.index') }}" class="btn btn-secondary mt-2">Kembali</a>
                            </form>
                        </div>
                    </div>
                </div>
