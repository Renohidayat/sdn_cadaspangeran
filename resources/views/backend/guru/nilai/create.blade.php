                    ...
                    <div class="card">
                        ...
                        <div class="card-body mt-2">
                            ...
                            <form action="{{ route('guru.nilai.store') }}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <small class="text-muted">Hanya menampilkan kelas yang Anda ajar.</small>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <small class="text-muted">Hanya menampilkan mata pelajaran yang Anda ajar.</small>
                                        </div>
                                        <div class="form-group">
                                ...
                                <a href="{{ route('guru.nilai.index') }}" class="btn btn-secondary mt-1">Kembali</a>
                            </form>
                        </div>
                    </div>
                </div>
