                                        ...
                                        <tbody>
                                           @foreach ($pengajar as $key => $pengajars)
                                                <tr>
                                                    ...
                                                    <td><a href=" {{route('backend-pengajar.edit', $pengajars->user->id)}} " class="btn btn-success btn-sm">Edit</a>
<form action="{{route('backend-pengajar.destroy', $pengajars->user->id)}}" method="POST" style="display:inline-block;">
    @csrf
    @method('DELETE')
