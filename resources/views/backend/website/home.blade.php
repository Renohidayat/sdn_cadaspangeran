                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="text-center">
                            ...
                            <p class="card-text m-auto w-75">
                                Ini adalah Dashboard Sistem Informasi Akademik Anda.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            @if (in_array(Auth::user()->role, ['Admin', 'Staf']))
                ...
                <div class="row">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div>
                                <h2 class="font-weight-bolder mb-0">{{$berita ?? 0}}</h2>
                ...
                <div class="row">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div>
                                <h2 class="font-weight-bolder mb-0">{{$pendaftar ?? 0}}</h2>
                                <p class="card-text">Pendaftar PPDB</p>
                            </div>
