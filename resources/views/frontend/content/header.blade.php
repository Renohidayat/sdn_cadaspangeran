            ...
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    <div class="header-top-left">
                        ...
                        @endif
                            <span style="font-size: 20px; font-weight: bold; color: #333; line-height: 1.2;">SD NEGERI<br>CADAS PANGERAN</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <nav id="desktop-nav">
                        <ul>
                            ...
                            <li class="{{ (request()->is('event')) ? 'active' : '' }}"><a href=" {{route('event')}} ">Event</a></li>
                            <li class="{{ (request()->is('kegiatan')) ? 'active' : '' }}"><a href=" {{route('kegiatan')}} ">Kegiatan</a></li>
                            <li class="{{ (request()->is('ppdb')) ? 'active' : '' }}"><a href=" {{route('ppdb')}} ">PPDB</a></li>
...
<script>
    var mobileLogoUrl = "{{ @$footer->logo ? asset('storage/images/logo/' . $footer->logo) : asset('Assets/Frontend/img/logo-footer.png') }}";
</script>
