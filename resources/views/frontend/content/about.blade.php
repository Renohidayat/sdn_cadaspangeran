    ...
    @if ($about != NULL)
        <div class="container">
            ...
            <div class="about-img-holder wow fadeIn" data-wow-duration="2s" data-wow-delay=".2s">
                <img src="{{asset('storage/images/about/' .$about->image)}}" alt="about" class="img-responsive" style="max-height: 450px; width: 100%; object-fit: cover; border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.15); margin: 0 auto;"/>
            </div>
        </div>
    @endif
</div>