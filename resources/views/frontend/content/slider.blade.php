<div class="bend niceties preview-1">
    <div id="ensign-nivoslider-3" class="slides" style="max-height: 550px">
        ...
        <img src="{{asset('storage/images/slider/' .$images->image)}}" alt="slider" title="#slider-direction-{{$key+1}}" style="max-height: 550px; width: 100%; object-fit: cover; filter: brightness(0.8);"/>
        @endforeach
    </div>
