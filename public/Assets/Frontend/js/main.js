(function($) {
    ...
    /*-------------------------------------
     ...
     --------------------------------------*/
    var logoUrl = typeof mobileLogoUrl !== 'undefined' ? mobileLogoUrl : 'img/mobile-logo.png';
    $('nav#dropdown').meanmenu({ siteLogo: "<a href='/' class='logo-mobile-menu'><img src='" + logoUrl + "' style='max-height:50px;' /></a>" });
